...
using Summa.Forms.Identity.Attributes;
using Summa.Forms.Identity.Models;
using static OpenIddict.Abstractions.OpenIddictConstants;

namespace Summa.Forms.Identity.Controllers
{
    public class AuthorizationController : Controller
    {
        ...
        public async Task<IActionResult> LogoutPost([FromQuery(Name = "post_logout_redirect_uri")]
            string redirectUri)
        {
